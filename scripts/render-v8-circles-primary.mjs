...
export function renderCirclesPrimary(sourceHtml = '') {
  ...
  if (!html.includes('v8-circles-primary.css')) html = html.replace('</head>', '<link rel="stylesheet" href="/assets/v8-circles-primary.css"><link rel="stylesheet" href="/assets/v8-circles-hierarchy-tightening.css?v=1"></head>');
