...
<div class="pp-research-band"><strong>WHAT PRACTICE CAN GROW</strong><div class="pp-research-benefits">${data.research.benefits.map((b)=>`<span>${esc(b)}</span>`).join('')}</div></div><p class="pp-research-translation">${esc(data.research.translation)}</p><div class="pp-research-actions"><a href="${attr(data.research.resources_url)}">${esc(data.research.resources_label)} →</a></div></div></section>
